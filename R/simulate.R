...
#' outcome is known and recoverable. Useful for testing and vignette examples
...
simulateMRData <- function(n = 5000,
  ...
  instrumentTable$strandAmbiguous <- isStrandAmbiguous(
    instrumentTable$effect_allele, instrumentTable$other_allele
  )
...
#' \code{\link{fitOutcomeModel}} at multiple sites. Log-likelihood profiles are
