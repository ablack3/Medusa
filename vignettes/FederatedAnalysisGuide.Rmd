...
The CSV files are human-readable and typically very small (< 100 KB) as they
contain only numeric grid values and summary statistics. Using CSV ensures that
every value leaving a site can be inspected and audited before transfer.
