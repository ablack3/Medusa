...
The `diagnosticFlags$negativeControlFailure` flag is TRUE if any negative
control outcome has a significant MR estimate (p < 0.05). This flag
appears alongside other diagnostic checks (weak instruments, allele
frequency discrepancies, genotype missingness) in the Medusa results
dashboard.
...
- **Summary cards** showing the number of NC outcomes, how many are
  significant, and whether bias was detected
